        ...
        <div className="tab-content" id="nav-tabContent">
          <div className="tab-pane fade" id="nav-past" role="tabpanel" aria-labelledby="nav-past-tab">
            <div className="row d-flex">
              ...
              <div className="col-9">
              <p className="text-center" style={{marginTop: "80px", fontSize: "50px"}}><strong>the~ P A S T ~is your lesson</strong></p>
              </div>
            </div>
          </div>
          <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <div className="col-3">
              ...
              <div className="col-9">
                <p className="text-center" style={{marginTop: "80px", fontSize: "50px"}}><strong>the~ P R E S E N T ~is your gift</strong></p>
              </div>
            </div>
          </div>
          <div className="tab-pane fade" id="nav-future" role="tabpanel" aria-labelledby="nav-future-tab">
            ...
            <div className="col-3">
              ...
              <div className="col-9">
              <p className="text-center" style={{marginTop: "80px", fontSize: "50px"}}><strong>the~ F U T U R E ~is your motivation</strong></p>
              </div>
            </div>
          </div>
        </div>
