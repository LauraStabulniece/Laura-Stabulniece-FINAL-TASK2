...
function Painting() {
    return (
        <div>
            ...
            <div className="container py-1 m-1">
                <div className="row align-items-md-stretch">
                    <div className="col-md-2 rounded-3">
                        <img src="/images/painting/1.png" class="card-img-top" alt="" />
                        <div class="card-body">
                ...
                <div className="row align-items-md-stretch" style={{ marginTop: "20px", marginBottom: "50px" }}>
                    ...
                    <div className="col-md-3">
                        <div className="h-100 p-5 bg-light border rounded-3">
                            <img src="/images/painting/2.png" class="card-img-top" alt="" />
                            <div class="card-body align-middle text-center">
                                <h4 class="card-text">I like to paint FLOWERS:</h4>
                    ...
                    <div className="col-md-3">
                        <div className="h-100 p-5 rounded-3" style={{ backgroundColor: "rgba(217, 245, 57, 0.411)" }}>
                            <img src="/images/painting/3.png" class="card-img-top" alt="" />
                            <div class="card-body">
                                <p class="card-text">Painting is just another way of keeping diary</p>
