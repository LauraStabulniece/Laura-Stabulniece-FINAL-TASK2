        ...
        <div>
            ...
            <div className="row align-items-md-stretch">
                ...
                <div className="card-body m-5 align-middle text-center">
                    ...
                    <div className="card-body m-5 align-middle text-center">
                        <p className="card-text" style={{ fontSize: "30px"}}>Where the spirit does not work with the hand, there is no art.</p>
                        <p style={{ color: "rgba(241, 68, 140, 0.685)", fontSize: "20px" }}>-Leonardo da Vinci</p>
                    </div>
                    <div className="card-body m-5 align-middle text-center">
            ...
            <div className="row align-items-md-stretch" style={{ marginTop: "0", marginLeft: "20px", marginRight: "90px", marginBottom: "100px" }}>
